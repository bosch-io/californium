...
public class CredentialsUtil {
	...
	public static void setupCredentials(DtlsConnectorConfig.Builder config, String certificateAlias, List<Mode> modes) {
		...
		if (noAuth) {
			...
			config.set(DtlsConfig.DTLS_CERTIFICATE_AUTH_MODE, CertificateAuthenticationMode.NONE);
		}
		else if (modes.contains(Mode.WANT_AUTH)) {
			config.set(DtlsConfig.DTLS_CERTIFICATE_AUTH_MODE, CertificateAuthenticationMode.WANTED);
		}
