...
public final class DtlsConnectorConfig {
	 ...
	 * @see DtlsConfig#DTLS_CERTIFICATE_AUTH_MODE
	 * @since 3.0
	 */
	public CertificateAuthenticationMode getCertificateAuthenticationMode() {
		return configuration.get(DtlsConfig.DTLS_CERTIFICATE_AUTH_MODE);
	}
	 ...
	 * @see <a href= "https://tools.ietf.org/html/rfc6347#section-4.1.2.6"
	 *      target= "_blank">RFC6347 4.1.2.6. Anti-Replay</a>
	 * @see DtlsConfig#DTLS_USE_EXTENDED_WINDOW_ANTI_REPLAY_FILTER
	 * @since 2.4
	 */
	public Integer useExtendedWindowFilter() {
		return configuration.get(DtlsConfig.DTLS_USE_EXTENDED_WINDOW_ANTI_REPLAY_FILTER);
	}
	...
	public static final class Builder {
		 ...
		 * <ul>
		 * <li><em>address</em>: a wildcard address with a system chosen
		 * ephemeral port see
		 * {@link InetSocketAddress#InetSocketAddress(int)}</li>
		 * <li><em>maxFragmentLength</em>: 4096 bytes</li>
		 * <li><em>maxPayloadSize</em>: 4096 + 25 bytes (max fragment size + 25
		 * bytes for headers)</li>
