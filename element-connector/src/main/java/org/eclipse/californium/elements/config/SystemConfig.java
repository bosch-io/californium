...
/**
 * Configuration definitions for basics/network.
 * 
 * @since 3.0
 */
public final class SystemConfig {
	...
	public static final TimeDefinition HEALTH_STATUS_INTERVAL = new TimeDefinition(MODULE + "HEALTH_STATUS_INTERVAL",
			"Health status interval. 0 to disable health status.", 0L, TimeUnit.SECONDS);
